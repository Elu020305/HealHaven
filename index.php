    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:32px; margin-top: 1% !important;">HEALhaven
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="cardio">Cardiology</button>
            <button class="btn btn-default filter-button" data-filter="neuro"> Neurology</button>
            <button class="btn btn-default filter-button" data-filter="lab">Laboratry</button>
        </div>
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter lab">
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter cardio">
